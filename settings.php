...
if ($hassiteconfig) {
    $temp = new admin_settingpage(
        'suspensionsettings',
        new lang_string('suspensionsettings', 'tool_usersuspension')
    );
    // Header.
    ...
    $temp->add(new admin_setting_configtext(
        'tool_usersuspension/domains_to_exclude',
    ...
    // Upload folder.
    $temp->add(
        new admin_setting_configdirectory(
    ...
    $temp->add(new admin_setting_description(
        'tool_usersuspension/csvexample',
    ...
    $temp->add(new admin_setting_configcheckbox(
        'tool_usersuspension/enablesmartdetect_warning',
